...
3. [`10-0713_libero_spatial_no_gen_fastwam_align_100k`](./10-0713_libero_spatial_no_gen_fastwam_align_100k.md)
...
4. [`5-0709_libero_spatial_no_gen_stable_10k`](./5-0709_libero_spatial_no_gen_stable_10k.md)
   - 原计划 10k，实际只运行到 step 724
   - 被正式 50k 实验替代

5. [`6-0710_libero_all_no_gen_stable_100k`](./6-0710_libero_all_no_gen_stable_100k.md)
   - 包含 `libero_90` 的五套训练
...
6. [`7-0712_libero_4suite_gen_act_stable_100k`](./7-0712_libero_4suite_gen_act_stable_100k.md)
...
7. [`12-0716_eval_exp7`](./12-0716_eval_exp7.md)
...
8. [`14-0723_libero_spatial_no_gen_fastwam_optim_align_100k`](./14-0723_libero_spatial_no_gen_fastwam_optim_align_100k.md)
